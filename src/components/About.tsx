    ...
    <section id="about" className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16 py-16 sm:py-24 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start mb-12 lg:mb-16">
        <div className="lg:col-span-8">
          <h2 className="text-[36px] sm:text-[48px] md:text-[58px] font-light tracking-tighter uppercase text-[#111111] leading-[0.95]">
            Engineering scalable platforms with <span className="font-serif italic lowercase font-normal">full-stack</span> depth & <span className="font-bold">AI integration</span>.
          </h2>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-8">
          <div
            onClick={onOpenVideo}
            className="relative aspect-[16/9] sm:aspect-[16/8.5] rounded-2xl overflow-hidden bg-[#F5F5F3] group cursor-pointer border border-[#E5E5E5] shadow-xs"
            role="button"
            tabIndex={0}
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-white text-[#111111] flex items-center justify-center transition-all duration-300 group-hover:scale-110 shadow-xl">
                <Play className="w-6 h-6 sm:w-7 sm:h-7 fill-[#111111] translate-x-0.5" />
              </div>
            </div>

            {/* Bottom Caption Pill */}
            <div className="absolute bottom-6 left-6 px-4 py-2 rounded-full bg-[#111111]/90 backdrop-blur-md text-[10px] font-bold uppercase tracking-wider text-white shadow-xs flex items-center gap-2">
        ...
        <div className="lg:col-span-4 flex flex-col justify-center space-y-10 sm:space-y-14 pl-0 lg:pl-6">
          {statistics.map((stat, idx) => (
            <div key={idx} className="border-t border-[#E5E5E5] pt-6 first:border-t-0 first:pt-0">
              <div className="text-[58px] sm:text-[72px] lg:text-[80px] font-light tracking-tighter text-[#111111] leading-none mb-2">
                {stat.value}
              </div>
              <div className="text-[11px] font-bold uppercase tracking-widest text-[#111111] mb-1">
                {stat.label}
              </div>
              <p className="text-[13px] text-[#8A8A8A] leading-normal max-w-[280px]">
                {stat.sublabel}
              </p>
            </div>
          ))}
